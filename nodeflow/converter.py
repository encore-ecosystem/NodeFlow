...
class Converter:
    ...
    def is_support_variable(self, variable_type: Type[object]) -> bool:
        return variable_type in self.graph

    def convert(self, variable: object, to_type: Type[object]) -> Optional[object]:
        pipeline, _ = self.get_converting_pipeline(source=variable.__class__, target=to_type)
